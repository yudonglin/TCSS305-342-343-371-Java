...
public abstract class AbstractCar extends AbstractVehicle {
     ...
     */
    protected AbstractCar(final int x, final int y, final Direction direction) {
     ...
     */
    protected AbstractCar(final int x, final int y, final Direction direction, final int deathTime) {
        super(x, y, direction, deathTime);
    }
